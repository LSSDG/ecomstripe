      ...
      <div className='w-full border-[1px] px-2 py-4'>
        <div className='flex justify-between items-center'>
          ...
          <div className='flex gap-2 relative overflow-hidden w-28 text-sm'>
            ...
            }} className='absolute z-20 w-[100px] text-gray-100 hover:text-gray-900 flex place-items-center gap-1 top-0 transform -translate-x-32 group-hover:translate-x-0 transition-transform cursor-pointer duration-500'>
